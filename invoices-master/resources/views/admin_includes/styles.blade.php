...
<link href="{{asset('assets/global/plugins/datetimepicker/bootstrap-datetimepicker.min.css')}}" rel="stylesheet"
      type="text/css"/>
...
<link rel="stylesheet" type="text/css" href="{{asset('assets/global/plugins/datatables/buttons/dataTables.min.css')}}"/>
...
<link href="{{asset('assets/week-picker-view.css')}}" rel="stylesheet"/>
<link href="{{asset('assets/global/plugins/bf-countrypicker/bootstrap-formhelpers.min.css')}}" rel="stylesheet"/>
<link rel="stylesheet" href="{{asset('assets/global/plugins/dragula/dragula.min.css')}}">
<link rel="stylesheet" href="{{asset('assets/global/plugins/signature-pad/css/signature-pad.css')}}">
<link rel="stylesheet" href="{{asset('assets/global/plugins/phone_input/css/intlTelInput.css')}}"></link>
<link href="{{asset('assets/fine-uploader/fine-uploader-new.css')}}" rel="stylesheet"/>
<link rel="stylesheet" href="{{asset('assets/global/plugins/fancybox/dist/jquery.fancybox.min.css')}}" type="text/css"
      media="screen"/>
@yield('theme_css')
