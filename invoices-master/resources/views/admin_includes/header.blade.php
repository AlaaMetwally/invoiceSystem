...
<div class="nda_notice"
    ...
    We have issued an updated version of our NDA. Please <a style="color:#999;" href="{{route('signature.sign_nda')}}">click
        here</a> to view and sign the updated NDA ( {{7-session('days_remaining')}} days remaining )
</div>
<?php ;}?>
