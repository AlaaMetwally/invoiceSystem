$(document).on('ready pjax:success', function () {
    $country = $("#country");
    CountryCity($country, 'country', 'city')

});

function CountryCity($country, countryElementId, stateElementId) {
    if($country.length){
        // Countries
...
// <!-- -->
        ...
        function populateCountries(countryElementId, stateElementId) {
            ...
            //set default value
            if(countryElement.dataset.defaultValue){
                countryElement.value = countryElement.dataset.defaultValue;
            }
