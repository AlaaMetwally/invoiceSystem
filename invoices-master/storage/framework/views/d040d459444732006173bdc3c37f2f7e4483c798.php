<div class="page-content-body">
    <div class="row" style="margin-left:0; margin-right:10px;">
        <form class="form-horizontal ajaxform" id="myForm" method="POST" action="<?php echo e(route('service.update',$service->id)); ?>">
            ...
            <div class="form-group">
                <label for="text" class="col-md-4 control-label">Service Info<span style="color:red;">*</span></label>
                <div class="col-md-6">
